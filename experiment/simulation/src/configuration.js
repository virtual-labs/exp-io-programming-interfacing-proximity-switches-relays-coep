...
// 	$("#ledtype").prop("disabled",true);	
	...
	<p>void loop() { </p>
  	...
  	<p>int sensorState = digitalRead(SENSOR_PIN);   &nbsp; &nbsp; &nbsp; &nbsp;     //Read the state of the sensor. An NPN sensor pulls the pin LOW when a metal object is detected </p>

 	<p>if (sensorState == LOW)  {			 &nbsp; &nbsp; &nbsp; &nbsp; 		// If a metal object is detected,   
	<p> digitalWrite(MOTOR_PIN, HIGH);        &nbsp; &nbsp; &nbsp; &nbsp;     // turn the motor ON </p>
 	<p> } else {
	<p> digitalWrite(MOTOR_PIN, LOW);        &nbsp; &nbsp; &nbsp; &nbsp;      // If no metal object is detected, turn the motor OFF </p>
 	<p> } </p>
	<p>}</p>`
//		+'<p></p>'
